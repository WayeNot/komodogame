    ...
    return (
        <div className="w-full h-full bg-black/70 flex flex-col items-center justify-center gap-8 text-white backdrop-blur-xs">
            ...
            <div className="flex flex-col items-center gap-2 w-full">
                <button onClick={startGame} className="w-2/3 py-4 bg-blue-500 rounded-xl hover:bg-blue-400 transition duration-500 cursor-pointer text-white font-bold text-xl">Rejouer</button>
