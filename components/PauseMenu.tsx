    ...
    return (
        <div className="w-full h-full flex items-center justify-center flex-col gap-8 bg-black/60 backdrop-blur-md">
            ...
            <div className="flex flex-col items-center gap-2 w-full">
                <button onClick={() => { setDisplayPauseMenu(false); setDisplayGame(true) }} className="w-2/3 py-4 bg-orange-500 rounded-xl hover:bg-orange-400 transition duration-500 cursor-pointer text-white font-bold text-xl">Retour au jeu</button>
